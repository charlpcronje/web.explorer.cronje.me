...
return [
     ...
     */
    'site_title' => env('SITE_TITLE', 'Web Explorer'),

    /**
     * Meta tag description text.
     *
     * Default value: 'Yet another directory listing, powered by Web Explorer.'.
     */
    'meta_description' => env('META_DESCRIPTION', 'Yet another directory listing, powered by Web Explorer.'),
